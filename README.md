...
| 🏷️ | 推荐角标与点击量 | 书签可标记为“推荐”，首页卡片显示红色「推荐/推」角标；鼠标悬浮卡片显示「今日点击 N 次」气泡，直观展示书签热度 |
| ✨ | 点击飘字特效 | 点击页面空白处从鼠标位置向上飘出“富强 民主 文明 和谐 自由 平等 公正 法治 爱国 敬业 诚信 友善”等字样，可用 `window.__clickPoemWords` 自定义词语库 |
